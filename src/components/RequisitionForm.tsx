            ...
            <div className="p-3 grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
              {formData.photos.map((photo) => {
                ...
                <div key={photo.id} className="relative group border rounded-lg overflow-hidden h-32 bg-gray-100">
                  {photo.dataUrl ? (
                    <img src={photo.dataUrl} alt="Attachment" className="w-full h-full object-cover" referrerPolicy="no-referrer" />
                  ) : driveThumb ? (
                    <div className="w-full h-full relative">
                        <img src={driveThumb} alt="Drive Thumbnail" className="w-full h-full object-cover opacity-90" referrerPolicy="no-referrer" />
